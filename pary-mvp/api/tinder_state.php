...
if ($session) {
    ...
    $allFinished = haveParticipantsFinishedTinderSession($participants, $progressMap, $total);
    ...
    if ($allFinished) {
        $rematchVotes = getTinderRematchVotes((int)$room['id'], (int)$session['id']);
        $rematchReady = haveParticipantsApprovedRematch($participants, $rematchVotes);
    }
}
